...
This outlines how to propose a change to AAGISurvey. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("AAGI-AUS/CBADASReml", fork = TRUE)`.
...
Please note that the {CBADASReml} project is released with a
[Contributor Code of
Conduct](https://AAGI-AUS.github.io/AAGISurvey/CODE_OF_CONDUCT.md). By
